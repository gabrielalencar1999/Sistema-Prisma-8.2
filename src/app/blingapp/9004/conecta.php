...
$sql = mysqli_query($conexao,"SELECT client_id,client_secret FROM info.consumidor where  CODIGO_CONSUMIDOR = '9004'") or die("Erro autenticação base ");
...
$sql_access_token = mysqli_query($conexao,"SELECT * FROM token where  refresh_token = '' AND idlogin = '9004' ") or die("Erro autenticação base ");
