...
<table  width="350" border="0">
		...
		<td  style="padding-left:5px;">
			<table width="300">
				...
				<tr>
						...
						<tr>
							<td colspan="5" style="text-align:left; "><b>VALOR A PAGAR R$ <?=number_format(($totalgeral+$valorfrete-$desconto),2,',','.');?></b></td>
	...
	<?php if($obs != "") {	?>			
				...
				<?php } ?>
	<tr>
		<td colspan="5" style="text-align:left; ">&numsp;</td>						
    </tr>
	<tr>
		<td colspan="5" style="text-align:left; ">&numsp;</td>						
    </tr>
...
<table  width="350" border="0">
	...
	<tr>
		<td class="center">CNPJ <?=$cnpj;?> <?=$razao;?> <br><?=$endereco?>, <?=$nmro;?>, <?=$Complemento_Endereco;?> <?=$bairro;?> <?=$cidade;?> <?=$estado;?> <?=$cep;?> FONE <?=$telefone;?> I.E. <?=$inscricao;?> <br><span style="font-size:14px; font-weight:bold;"><br><hr>** ORÇAMENTO **<hr></span></td>
	</tr>
	<tr>
		<td class="center" style="padding-left:5px;">
			<table width="300">
				...
				<?php 	
						$sql = "select * FROM ".$_SESSION['BASE'].".saidaestoqueitem where NUMERO = '$pedido'";
				...
				?>
						<tr> 
							<td style="font-size:12px;"><?=$name['ITEM'];?></td>
				...
				<?php 	} ?>
						...
						<tr>
							<td colspan="5" style="text-align:left; font-size:10px;"><b>VALOR PAGAR R$</b></td>
							<td style="font-size:12px; text-align:right;"><?=number_format(($totalgeral-$desconto),2,',','.');?></td>
						</tr>
						<?php
						 ?>
			</table>
	...
	<tr>
		<td class="center"><hr>Data do orçamento: <?=$datac;?><br><br></td>
	</tr>
