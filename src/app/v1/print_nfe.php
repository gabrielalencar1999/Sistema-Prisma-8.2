...
try {
 ...
 if($_POST['osfinan'] != "") {
        $sql = "SELECT nfed_xml_protocolado,empresa_tipo FROM " . $_SESSION['BASE'] . ".NFE_DADOS 
        ...
        $empresa_tipo = $retorno['empresa_tipo'];
...
$oldY += $h;
  ...
  //####################################################################################
        ...
        //dados e logo
        $_razao = $arrOutput['NFe']['infNFe']['emit']['xNome'];
        if(strlen($_razao) > 50){
...
//   exit();
      ...
      $dups = $arrOutput['NFe']['infNFe']['cobr']['dup'];
          ...
          // $_cst  = '2500';
            ...
            if($_cst == ""){
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS00']['pICMS'],0,5), 2, ",", ".");     
         
             }
            if($_cst == ""){
              $_cst  = $value['imposto']['ICMS']['ICMS10']['CST'];
              $_basecalculo = $value['imposto']['ICMS']['ICMS10']['vBC'];
              $_valoricms = $value['imposto']['ICMS']['ICMS10']['vICMS'];
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS10']['pICMS'],0,5), 2, ",", ".");    
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS20']['pICMS'],0,5), 2, ",", ".");    
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS40']['pICMS'],0,5), 2, ",", ".");    
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS41']['pICMS'],0,5), 2, ",", ".");    
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS60']['pICMS'],0,5), 2, ",", ".");    
         
             }
             if($_cst == ""){
              $_cst  = $value['imposto']['ICMS']['ICMS90']['CST'];
              $_basecalculo = $value['imposto']['ICMS']['ICMS90']['vBC'];
              $_valoricms = $value['imposto']['ICMS']['ICMS90']['vICMS'];   
              $_aliIcms = number_format(substr($value['imposto']['ICMS']['ICMS90']['pICMS'],0,5), 2, ",", ".");           
             }
         ...
         if( $prod == 1){
            ...
            if($_cst  == "") {
             ...
             // $_aliIcms = number_format(['ICMS']['ICMSSN900']['pICMS'], 2, ",", ".");  
              $_aliIcms = number_format(substr($value['ICMS']['ICMSSN900']['pICMS'],0,5), 2, ",", ".");     
            //  $_cst  = '2500';
            }
            if($_cst  == "") {
            ...
            if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS00']['pICMS'],0,5), 2, ",", ".");     
            ...
            if($_cst == ""){
              ...
              $_basecalculo = $value['ICMS']['ICMS00']['vBC'];
              $_valoricms = $value['ICMS']['ICMS00']['vICMS'];
              $_aliIcms = number_format(substr($value['ICMS']['ICMS10']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS20']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS30']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS40']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS41']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS60']['pICMS'],0,5), 2, ",", ".");     
             ...
             if($_cst == ""){
              ...
              $_aliIcms = number_format(substr($value['ICMS']['ICMS90']['pICMS'],0,5), 2, ",", ".");     
            ...
            if ($i >= ($ULTIMOITEM) ) {
                    ...
                    if($linhaM <= 188) {                
                       $novacontagem++;
                        ...
                        $_aliIpiDEVvlr  =  $arrOutput['infNFe']['det']["impostoDevol"]["vIPIDevol"];
