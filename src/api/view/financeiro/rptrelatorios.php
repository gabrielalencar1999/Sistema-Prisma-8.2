...
$_subgrupo = $_parametros['nf-contdespesa']; //sub categoria
$_tipopgto = $_parametros['relatorio-tipopgto'];
$_empresa = $_parametros['relatorio-empresa'];
$_conta = $_parametros['relatorio-conta']; //usando para conta corrente
...
if($_conta != "0") { //conta 
    $_filtroconta = " AND financeiro_caixa = '$_conta'";

    	$consulta = "Select Descricao from livro_caixa_numero WHERE Livro_Numero = '$_conta'";
    
	    $executa = mysqli_query($mysqli, $consulta) or die(mysqli_error($mysqli));
        while ($rst = mysqli_fetch_array($executa)) {	
              $_desconta = $rst["Descricao"];
        }
}
...
if ($_acao == 1 and $_tiporelatorio == 1) { //DRE SINTETICO
    ...
    ?>
        ...
        <tr>
            ...
            <?php if( $_conta != "0" ){ echo "Conta: <strong>$_desconta</strong>"; } ?>
            </td>
        </tr>
        <tr>
        ...
        <?php 
          //Suprimento Financeiro E MOVIMENTAÇÃO ENTRADA EM VALOR 
                            ...
                            where categoria_saldo ='1' and financeiro_situacaoID = 0 and  $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00'  and financeiro_tipo = '0'
                            $_filtrosit $_filtrogrupo $_filtroempresa   $_filtroconta $_filtropgto                          
                            ...
                            $num_rowsG = mysqli_num_rows($executaG);		
                                    if($num_rowsG!=0)
                                        {?>
                                                  <span class="style38"><strong>Suprimento Financeiro</strong></span> 
                                    ...
                                    <td  class="titgrid style33 style35"><div align="center"><strong>VALOR PAGO R$</strong></div>      </td>
                                       ...
                                       <?php 
                                         while($rstG = mysqli_fetch_array($executaG))						
                                            ...
                                            $totalSuprimentos= $totalSuprimento +  $rstG["totalPAGO"];       
                                            ...
                                            inner join financeiro on financeiro_subgrupo = id_subcategoria
                                             LEFT join categoria  on financeiro_grupo = id_categoria
                                            where categoria_saldo ='1' and financeiro_situacaoID = 0 and   $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00' 
                                            and financeiro_tipo = '0' and  ref_subcategoria = '$grupoId' 
                                            $_filtrosit $_filtroempresa  $_filtroconta $_filtropgto
            ...
            <span class="style38"><strong>RECEITAS</strong></span> 
                ...
                //RECEITAS
                            $grupo = "Select id_categoria ,descricao_categoria,sum(financeiro_valor) as total,sum(financeiro_valorFim) as totalPAGO	 from financeiro
                            LEFT join categoria  on financeiro_grupo = id_categoria
                            where categoria_saldo ='0' and financeiro_situacaoID = 0 and  $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00'  and financeiro_tipo = '0'
                            $_filtrosit $_filtrogrupo $_filtroempresa  $_filtroconta $_filtropgto
                            OR
                             categoria_saldo IS NULL and financeiro_situacaoID = 0 and  $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00'  and financeiro_tipo = '0'
                            $_filtrosit $_filtrogrupo $_filtroempresa   $_filtroconta $_filtropgto
                            group by id_categoria ,descricao_categoria
                            order by descricao_categoria ";           
                                    ...
                                    if($num_rowsG!=0)
                                        {
                                            ...
                                            inner join financeiro on financeiro_subgrupo = id_subcategoria
                                             LEFT join categoria  on financeiro_grupo = id_categoria
                                            where categoria_saldo ='0' and financeiro_situacaoID = 0 and   $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00' 
                                            and financeiro_tipo = '0' and  ref_subcategoria = '$grupoId' 
                                            $_filtrosit $_filtroempresa  $_filtroconta $_filtropgto 
                                            OR
                                            categoria_saldo IS NULL and financeiro_situacaoID = 0 and   $_datafiltro BETWEEN '$datainiP 00:00:00' and  '$datafimP 23:59:00' 
                                            and financeiro_tipo = '0' and  ref_subcategoria = '$grupoId' 
                                            $_filtrosit $_filtroempresa   $_filtroconta $_filtropgto
                                            group by id_subcategoria ,descricao_subcategoria
                                            order by descricao_subcategoria ";                                                                  
...
if ($_acao == 1 and $_tiporelatorio == 2) { //RELATORIO ANALITICO
    ...
    if($_situacao == 1) { //aberto        
     ...
     if($vendedor != ""){
        $fil = "and financeiro_usucom = '".$vendedor."' 	";
    ...
    ?>
        ...
        <tr>
            <td colspan="2" class="style34" >Período de <?=$_datainiT;?>  até <?=$_datafimT;?>
             <?php 
              if($_vendedornome != "") { echo " ($_vendedornome)";}
             if( $_conta != "0" ){ echo "Conta: <strong>$_desconta</strong>"; } ?>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="linha" ></td>
                ...
                //RECEITAS
                            ...
                            $_filtrosit $_filtrogrupo    $_filtrofinanceiro_tipo    $_filtroempresa  $_filtroconta $_filtropgto   $fil
                            OR 
                            categoria_saldo IS NULL and financeiro_situacaoID = 0 and  $_datafiltro BETWEEN '$datainiP 00:00' and  '$datafimP 23:59' 
                            $_filtrosit $_filtrogrupo    $_filtrofinanceiro_tipo     $_filtroempresa $_filtroconta $_filtropgto  $fil                     
