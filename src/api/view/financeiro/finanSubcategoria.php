	...
	if($_parametros != ""){
		...
		$variable = $_parametros['idCategoria'];
		...
		if($descricaoSubcategoria != ""){
			...
			$exe = Financeiro::insert_subcategoria($_parametros);
		}
		$_parametros = "";
	}
	if($variable != ""){	
	...
	<div class="row">
		<div class="col-sm-12" align="center">
			<label class="control-label">Selecione uma subcategoria (Opcional)</label><br>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-9">
			<select class="form-control" id="subcategoria" name="subcategoria" onchange="selecionarSubcategoria(this.value)">
