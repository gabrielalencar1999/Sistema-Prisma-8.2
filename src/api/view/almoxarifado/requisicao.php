...
?>
    ...
    require_once('navigatorbar.php');
        ...
        if($_SESSION['per231'] == '231') {
            $_idtecnico = $_SESSION["tecnico"];
            $consulta = $pdo->query("SELECT usuario_CODIGOUSUARIO,usuario_NOME,usuario_almox  
            FROM " . $_SESSION['BASE'] . ".usuario   where usuario_CODIGOUSUARIO = '$_idtecnico'  ");
            $result = $consulta->fetchAll();
            foreach ($result as $row) {
                $filtroAmoxA = " AND Codigo_Almox = '".$row["usuario_almox"]."'" ;
            }
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="btn-group pull-right m-t-20">
                            <div class="m-b-30">
                                <button type="button" id="opPrint"  class="btn btn-white waves-effect waves-light" data-toggle="tooltip"  data-placement="top" title="Opções Impressão" onclick="_printOpcao()"> <i class="fa  fa-print"></i></button>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php
                              ...
                              require_once('../../api/view/almoxarifado/requisicao_list.php'); ?>
                        </div>
                    </div>
                </div>
                       ...
                       <input type="hidden" id="acaoRel" name="acaoRel"  value="">                   
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">                                                    
                                                            <Select  class="form-control" id="_tipomov"  name="_tipomov" > 
                                                            <option value="">Todos</option>                                                    
                                                                <?php                                                              
                                                                    $consulta = $pdo->query("SELECT *  FROM " . $_SESSION['BASE'] . ".tabmovtoestoque
                                                                                        ORDER BY Descricao");
                                                                    $result = $consulta->fetchAll();
                                                                        foreach ($result as $row) {
                                                                            ?><option value="<?=$row["Tipo_Movto_Estoque"];?>"><?=$row["Descricao"];?></option><?php
                                                                        }
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                     <label for="field-1" class="control-label">Almoxarifados</label>
                                                </div>   
                                                <div class="col-md-4">
                                                    <div class="form-group">                                                    
                                                        ...
                                                        <option value="">Todos</option>                                                    
                                                            <?php  
                                                                ...
                                                                $consulta = $pdo->query("SELECT *  FROM " . $_SESSION['BASE'] . ".almoxarifado where almox_ativo = '1' $filtroAmoxA ORDER BY Descricao");
                                                                $result = $consulta->fetchAll();
                                                                    foreach ($result as $row) {
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="00003" onclick="_00003()"  data-dismiss="modal" class="btn btn-info waves-effect waves-light">Filtrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal -->
                        </form>
                        <form id="formAvanc" name="formAvanc" action="javascript:void(0)">                      
                            <div id="modalPrint" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <label for="field-1" class="control-label">Modelo</label>
                                                    <div class="form-group">                                                       
                                                    <Select  class="form-control" id="_situacaorel"  name="_situacaorel" >
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-inverse waves-effect" data-dismiss="modal">Fechar</button>
                                            <button type="button" id="btprint" onclick="_print()"  class="btn btn-info waves-effect waves-light">Imprimir</button>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal -->
