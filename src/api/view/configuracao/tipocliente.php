...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Tipo Cliente</h4>
                <p class="text-muted page-title-alt">Cadastre seus tipos de clientes.</p>
            </div>
    ...
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir tipo de cliente</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cliente-descricao" id="cliente-descricao" placeholder="Informe a descrição do cliente" value="">
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function _buscadados(id) {
        $('#id-altera').val(id);
        var $_keyid = "acaotipocliente_0001";
