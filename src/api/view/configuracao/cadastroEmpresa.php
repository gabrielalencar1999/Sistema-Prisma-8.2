                    ...
                    <div class="panel-body">
                        ...
                        <form action="acaoCadastroEmpresa" method="post" name="form-alterar" id="form-alterar">
                            <div class="tab-content br-n pn">
                                ...
                                <button type="button" class="btn btn-inverse waves-effect m-l-5" id="voltar">Fechar</button>
                                    <button type="button" class="btn btn-success waves-effect waves-light" id="salvardados" data-toggle="modal" data-target="#salvar" onClick="_alterar()">Salvar</button>                              
