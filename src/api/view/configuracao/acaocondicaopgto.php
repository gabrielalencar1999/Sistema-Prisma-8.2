...
if ($acao["acao"] == 0) {
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="condicao-prazo-normal" value="<?=htmlspecialchars($retorno["prz"])?>">
        </div>
    </div>
    <div class="col-md-4">
    <div class="form-group">
    ...
    <option value="<?= htmlspecialchars($row['Livro_Numero']) ?>" 
        <?= $row['Livro_Numero'] == $retorno["Num_Livro"] ? "selected" : "" ?>>
    ...
    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap " cellspacing="0" width="100%">
        ...
        ?>
            <tr class="gradeX">
                ...
                <td class="text-center"><?= htmlspecialchars($rst["nome"]) ?></td>
                <td class="text-center"><?= htmlspecialchars($rst["QT_Parcelas"]) ?></td>
                <td class="text-center"><?= htmlspecialchars($rst["prz"]) ?></td>
                <td class="text-center"><?= htmlspecialchars($rst["Ind_liquida"]) ?></td>
                <td><?= htmlspecialchars($rst["tpnfce_descricao"]) ?></td>  
...
WHERE id = ?");
            ...
            $statement->bindParam(11, $_parametros["condicao-id"]);
        ...
        ':parcela' => $i
           ...
           ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
<h2>Erro: <?= htmlspecialchars($e->getMessage()) ?></h2>
