...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Fornecedor</h4>
                <p class="text-muted page-title-alt">Cadastro fornecedores e Fabricantes</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content text-left">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir Linha</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="fornecedor-descricao" class="control-label">Descrição:</label>
                                <input type="text" class="form-control" name="fornecedor-descricao" id="fornecedor-descricao" placeholder="Informe a descrição da linha" value="">
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function _buscadados(id) {
        $('#id-altera').val(id);
        var $_keyid = "acaotipofornecedor_0001";
