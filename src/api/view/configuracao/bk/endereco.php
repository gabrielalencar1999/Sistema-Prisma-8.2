...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Endereços Estoque</h4>               
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="enderecoA" id="enderecoA" placeholder="Informe a descrição " value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="enderecoB" id="enderecoB" placeholder="Informe a descrição " value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="enderecoC-descricao" class="control-label">Endereço C:</label>
                                <input type="text" class="form-control" name="enderecoC" id="enderecoC" placeholder="Informe a descrição " value="">
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content text-center">
            <div class="modal-body">
                <div id="result-exclui" class="result">
                    ...
                    <h2>Deseja realmente excluir endereco? </h2>
                    <p>
