...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Estoque Compartilhado</h4>
                <p class="text-muted page-title-alt">Lista de Parceiros - Prisma</p>
                <code>Visualização para consulta de estoque será visualizado apenas quando as duas partes estiverem feito o compartilhamento.</code>
            </div>
            <div class="btn-group pull-right m-t-20">
                <div class="m-b-30">
                   <?php /* <button class="btn btn-default waves-effect waves-light" data-toggle="modal" data-target="#custom-modal-filtro"><span class="btn-label"><i class="fa fa-gears"></i></span>Filtros</button> */
                   ?>
...
<script type="text/javascript">
    ...
    function _compartilharaceita(id,dv) {
        $('#id-altera').val(id);
        var $_keyid = "estcomp_00002";
        var dados = $("#form1 :input").serializeArray();
        dados = JSON.stringify(dados);
    ...
    function _cancelarcompartilhar(id,dv) {
        $('#id-altera').val(id);
        var $_keyid = "estcomp_00002";
        var dados = $("#form1 :input").serializeArray();
        dados = JSON.stringify(dados);
