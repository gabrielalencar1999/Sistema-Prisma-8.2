...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Grupo de Despesas e Receitas</h4>
                <p class="text-muted page-title-alt">Cadastre seus tipos de Receitas e Despesas.</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="grupo-descricao" id="grupo-descricao" placeholder="Informe a descrição do cliente" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    function _buscadados(id) {
        $('#id-altera').val(id);
        var $_keyid = "acaogrupodespesa_0001";
