...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15"><?=$extra_a?></h4>
    ...
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir <?=$extra_a?></h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="extra-a-descricao" id="extra-a-descricao" placeholder="Informe a descrição" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="extra-a-descricao-site" class="control-label">Descrição Site:</label>
                                <input type="text" class="form-control" name="extra-a-descricao-site" id="extra-a-descricao-site" placeholder="Informe a descrição para o site" value="">
                            </div>
                        </div>
                    </div>
                </form>
