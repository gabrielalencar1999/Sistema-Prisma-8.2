...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Almoxarifado</h4>
                <p class="text-muted page-title-alt">Cadastre seus almoxarifados.</p>
            </div>
    ...
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir Almoxarifado</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="almoxarifado-descricao" id="almoxarifado-descricao" placeholder="Informe a descrição da almoxarifado" value="">
                            </div>
                        </div>
                    </div>
                </form>
...
<form  id="form1" name="form1" method="post" action="">
    ...
    <input type="hidden" id="id-exclusaouser" name="id-exclusaouser" value="">
    <input type="hidden" id="almoxuserF" name="almoxuserF" value="">
...
<script type="text/javascript">
    ...
    function _buscadados(id) {
        $('#id-altera').val(id);
        var $_keyid = "acaoalmoxarifado_0001";
    ...
    function _idexcluiruser(id) {
        var $_keyid = "acaoalmoxarifado_0001";
        $("#almoxuserF").val("");
        $("#id-exclusaouser").val(id);
