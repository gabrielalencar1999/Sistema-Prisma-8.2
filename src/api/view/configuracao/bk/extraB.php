...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15"><?=$extra_b?></h4>
                <p class="text-muted page-title-alt">Cadastre seus grupos personalizados.</p>
            </div>
            <div class="btn-group pull-right m-t-20">
                <div class="m-b-30">
                    <button id="addToTable" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#custom-modal-incluir"><span class="btn-label"><i class="fa fa-plus"></i></span>Incluir</button>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir <?=$extra_b?></h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="extra-b-descricao" id="extra-b-descricao" placeholder="Informe a descrição" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="extra-b-descricao-site" class="control-label">Descrição Site:</label>
                                <input type="text" class="form-control" name="extra-b-descricao-site" id="extra-b-descricao-site" placeholder="Informe a descrição para o site" value="">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success waves-effect waves-light" data-dismiss="modal" onclick="_incluir()">Salvar</button>
            </div>
        </div>
    </div>
</div>
