...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Cartões - Finpet</h4>
                <p class="text-muted page-title-alt">Lista de recebiveis habilitado</p>
            </div>
...
<script type="text/javascript">
    ...
    function _lista() {
        var $_keyid = "finpet_action";
        $.post("page_return.php", {_keyform:$_keyid, acao: 3},
            function(result){
