...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Linhas</h4>
                <p class="text-muted page-title-alt">Cadastre as linhas dos seus produtos.</p>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive" id="linha-listagem">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="linha-descricao" id="linha-descricao" placeholder="Informe a descrição da linha" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
