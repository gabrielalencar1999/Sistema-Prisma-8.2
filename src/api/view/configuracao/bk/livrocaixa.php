...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Livros Caixa</h4>
                <p class="text-muted page-title-alt">Cadastre seus Livros Caixa.</p>
            </div>
    ...
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Incluir Livro</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="livro-descricao" class="control-label">Descrição:</label>
                                <input type="text" class="form-control" name="livro-descricao" id="livro-descricao" placeholder="Informe a descrição do livro" value="">
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function _buscadados(id) {
        $('#id-altera').val(id);
        var $_keyid = "acaolivrocaixa_0001";
