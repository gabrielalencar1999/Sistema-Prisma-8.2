...
<div class="wrapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <h4 class="page-title m-t-15">Centro de Custo e Projetos </h4>
                <p class="text-muted page-title-alt">Cadastre seus centros de custo e projetos </p>
            </div>
            <div class="btn-group pull-right m-t-20">
                <div class="m-b-30">
                    ...
                    <button id="addToTable" class="btn btn-success waves-effect waves-light" onclick="_fechar()">Fechar <i class="fa fa-remove"></i></button>
                </div>
            </div>
        </div>
        <div class="row">
...
<!-- Modal Incluir -->
<div id="custom-modal-incluir" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog text-left">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Incluir Projeto</h4>
            </div>
            <div class="modal-body">
                <form action="javascript:void(0)" method="post" enctype="multipart/form-data" name="form-inclui" id="form-inclui">
                <input type="hidden" name="projeto-inicio" id="projeto-inicio" class="form-control">
                <input type="hidden" name="projeto-fim" id="projeto-fim" class="form-control">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="projeto-descricao" class="control-label">Descrição:</label>
                                <input type="text" class="form-control" name="projeto-descricao" id="projeto-descricao" placeholder="Informe a descrição do projeto">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="projeto-valor" id="projeto-valor" class="form-control" placeholder="Informe o valor em R$">
                            </div>
                        </div>
                    </div>
                </form>
...
<!-- Modal Alterar -->
<div id="custom-modal-alterar" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
...
<!-- Modal Excluir -->
<div id="custom-modal-excluir" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content text-center">
            <div class="modal-body">
                <div id="result-exclui" class="result">
                    ...
                    <h2>Deseja realmente excluir registro? </h2>
                    <p>
...
<script src="assets/js/routesV2_1.js<?=$_SESSION['VersionCache'];?>"></script>
