  ...
  <td width="696"><div align="left" width="783" >
    <table width="1013" border="0">
      <tr>
        ...
        <td height="58" colspan="3" class="matricial2">CNPJ:
<?=$cnpj;?> <br />
     
      
        Central de vendas <?=$fax;?> <br />
WhatsApp 
<?=$telefone;?>
  ...
  <tr>
    <td><table width="1005" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="105" ><span class="matricial2">Código:
        <?=$rstPedido["CODIGO_CONSUMIDOR"];?>
        </span></td>
        <td colspan="2" ><span class="matricial2"> Cliente:
...
<?=$rstPedido["estado"];?>        
  ...
  <tr>
    ...
    <table width="1005" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          <td height="20" ><span class="matricial2">Ass. Cliente:</span></td>
          <td colspan="3" valign="top" ><span class="matricial2">. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . Data Entrada:. . . . .  . / . . . . .  . /. . . . .  .</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <?php if($rstPedido['tecnico']!= "" AND $rstPedido['SituacaoOS_Elx'] == 6) { ?>
