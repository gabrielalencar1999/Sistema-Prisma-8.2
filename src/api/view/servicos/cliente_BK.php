...
?>  
    ...
    <input type="hidden" id="_cod_aparelho" name="_cod_aparelho"  value="">
    <input type="hidden" id="_idequipamento" name="_idequipamento"  value="">
           ...
           <form id="form5" name="form5">                      
                        ...
                        <form id="form7" name="form7">                      
                            ...
                            <div id="custom-modal-os" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
                                <div class="modal-dialog  modal-lg">
                                    <div class="modal-content " >        
                                        <div class="modal-body text-center" id="avisoOS">
            ...
            function  _000008(){
                   ...
                   function  _newproduto(){                                    
                      ...
                      $('#_keyform').val($_keyid);   
                       ...
                       $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 32}, function(result){	                      			
                         
                            $("#divProdutoCli").html(result);   
                ...
                function _aparelhoSEL(aparelho,marca,modelo,preventivo,cod_aparelho){
                    var $_keyid = "S00012";
                    $('#_cod_aparelho').val(cod_aparelho) ;
                ...
                function _aparelhoSalvar(){
                    var $_keyid = "S00012";
                    $('#_idclienteAP').val($('#_idcliente').val()) ;
                    var dados = $("#formAp :input").serializeArray();
                    dados = JSON.stringify(dados);       
                       ...
                       if(result == "") {
                        ...
                        $.post("page_return.php", {
                                ...
                                $('#_keyform').val($_keyid);   
                                    ...
                                    dados = $("#form6 :input").serializeArray();
                                    dados = JSON.stringify(dados);
                ...
                function _aparelhoEditar(_codaparelho){
                    var $_keyid = "S00012";
                    $('#_idequipamento').val(_codaparelho) ;
