                                    ...
                                    <div id="navpills-31" class="tab-pane">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                // if ($situacaoA != 6 and $situacaoA != 10 and $situacaoA != 13) {
                                                    if ($situacaoBloquea != 1 ) { ?>                                                        
                                                                <button type="button" style="margin:5px ;" class="btn btn-default btn-block" data-toggle="modal" data-target="#custom-modal-SOS" onclick="sos_m()"><i class="fa  fa-fire m-r-5"></i>S.O.S</button>                                                        
                                                    <?php } ?>
                ...
                <div class="modal-body">
                    <div id="result-sos" class="result">
                        <div class="row">
                            ...
                            <div class="col-sm-12 ">
                                <div class="row" style="margin-bottom:5px ;">
                                    <div class="col-sm-4"> <label>Produto S.O.S</label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" name="sosproduto" id="sosproduto" value="<?= $rst['Cod_Prod_SOS'] ?>">
                                    </div>
                                </div>
                                <div class="row" style="margin-bottom: 5px;">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input name="dtemprestimo" type="date" value="<?= $rst["Data_Entrega_SOS"]; ?>" id="dtemprestimo" size="10" class="form-control input-sm" />
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-bottom: 5px;">
                                    ...
                                    <div class="col-sm-3">
                                        <input name="dtdevolucao" type="date" id="dtdevolucao" class="form-control input-sm" value="<?= $rst["Data_Baixa_SOS"]; ?>" size="15" maxlength="10" />
                                    </div>
                                </div>
                            </div>
                        </div>
