    ...
    <div class="wrapper">
            <div class="container" style="width:98%">
                ...
                <div class="row">
                        <div class="col-xs-4">
                            ...
                            <p class="text-muted page-title-alt">Lista de Clientes</p>
                        </div>
                    
                        <div class="btn-group pull-right m-t-20">
                            <div class="m-b-10">
                                 <button  class="btn btn-purple  waves-effect waves-light"  aria-expanded="false" id="_QR" onclick="_qr()" data-toggle="modal" data-target="#custom-width-qr"> <i class="glyphicon glyphicon-qrcode"></i></button>
            ...
            <div class="row" >
                    ...
                    <div id="modalfiltro" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">                                                                    
                                                 ...
                                                 <div class="row">                                                                    
                                                                    <div class="col-md-2">
                                                                        <label for="field-1" class="control-label">Qtde Registros</label>
                                                                    </div>   
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">                                                       
                                                                        <select class="form-control" name="_limite" id="_limite" >    
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <?php if($_SESSION['per160'] != "") { ?>
                                                    <button type="button" id="_00003export"  class="btn btn-white waves-effect waves-light" onclick="_exportar()"><i class="fa  fa-file-excel-o"></i> Exportar</button>
                                                <?php } ?>
                                                <button type="button" id="_00c003"  class="btn btn-info waves-effect waves-light" onclick="_000009()">Filtrar</button>
                        ...
                        <div class="card-box table-responsive" id="_resultclinew" st >                      
                            <?php
                                    $_parametros = array();
                                require_once('../../api/view/servicos/clientelista.php'); ?>
                            </div>
                        </form>
                    </div>
                </div> <!-- end container -->
           ...
           <form id="form5" name="form5">                      
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="card-box" >  
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 ">
                                                     <button type="button" class="btn btn-block btn--md waves-effect waves-light btn-default" onclick="_consAlt()" ><i class="fa  fa-user"></i> Dados Cadastrais</button>                                                                                                         
                                                </div>  
                                                <div class="col-md-6">                                                    
                                                     <button type="button" class="btn btn-block btn--md btn-inverse waves-effect waves-light"  onclick="_fichaHistOS();"><i class="fa fa-keyboard-o"></i> Ficha de Atendimento</button>                                                     
                                                </div> 
                                                <div class="col-md-6">                                                     
                        ...
                        <form id="form7" name="form7">                      
                            ...
                            <div id="custom-modal-os" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
                                        ...
                                        <div class="modal-body" id="avisoOS">
                                            ...
                                            <i class="md-3x   md-loupe text-success"></i>
                                                ...
                                                <p>
                                                    ...
                                                    <button  class="confirm btn   btn-default btn-md waves-effect waves-light" tabindex="1" style="display: inline-block;" onclick="_newOSAcao()">Nova O.S</button>
                                                </p>
                                                </span>
                                            <div >                 
                                            </div>
                             ...
                             <!--QR os -->
                             <div id="custom-width-qr" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;" data-backdrop="static">
                             <div class="modal-dialog ">
                                     <div class="modal-content ">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                                                <h4 class="modal-title">Link Portal e Totem</h4>
                                            </div>
                                            <div class="modal-body">
                                                <form action="javascript:void(0)" method="post" enctype="multipart/form-data" name="form-qrcode" id="form-qrcode">
                                                    <div id="qrcoderet">
...
/*-
    ...
    */
            ...
            function _qr() {
                    ...
                    _carregando('#qrcoderet');
                
                  
                    $.post("page_return.php", {_keyform:$_keyid}, function(result){		                                
                            $("#qrcoderet").html(result);                 
                        });
            }

            function _copy() {
            let textoCopiado = document.getElementById("linkqrcode");
            textoCopiado.select();
        ...
        function validarTefone(){
                  $("#retcpf").html(""); 
                    ...
                    $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 100}, function(result){	
            ...
            function _regiao(){        
              ...
              //  $('#modalopcaodiv').modal('show');  
                     var $_keyid =   "_ATa00009";    
                     var dados = $("#form6 :input").serializeArray();
                     dados = JSON.stringify(dados);   
                  //   _carregando('#_opcaodiv');
                     _carregando('#_newclinew');
                         $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 8}, function(result){   
                                                                                                                                              ;
                       //  $("#_opcaodiv").html(result);   
                       $("#_newclinew").html(result);   
                       $('#custom-width-cli').modal('handleUpdate') ;                                                                   
                     });
                ...
                function  _consVendas(){                     
                     ...
                     _carregando('#_newclinew');
                         ...
                         $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 12}, function(result){  
            ...
            function  _000008(){
                        ...
                        $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao:22}, function(result){
                                if(result == ""){
                                    ...
                                    $.Notification.notify('error', 'right Top','AVISO!', result);
                   ...
                   function  _000010($_idref){
                    ...
                    function _exportar() {
                        ...
                        var $_keyid = "rel_00001";
                        $("#modalfiltro").modal('hide');
                        var dados = $("#form3 :input").serializeArray();
                            dados = JSON.stringify(dados);         
                            _carregando('#imagem-carregando');                             
                        ...
                        $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao:1},
                            function(result){  
                                    ...
                                    $("#imagem-carregando").html(result); 
                                    $("#custom-modal-relatorio").modal('show');
                            });                       
                   
                    }

                    function  _100010($_idref){
                    ...
                    function  _100011($_idcliente){
                        ...
                        $.post("verPermissao.php", {
                            ...
                            if (result != "") {
                                ...
                                window.open("/app/v1/pdv/caixa.php?refidC=" + $_idcliente, "_blank");
                     ...
                     // $('#custom-width-cli').modal('show');  
                      ...
                      $('#_keyform').val($_keyid);   
                       ...
                       $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 33}, function(result){	
                          ...
                          if(result == ""){
                            $.post("page_return.php", {_keyform:$_keyid,dados:dados, acao: 333}, function(result){								
                                $("#avisocliente").html(result);              
                                }); 
