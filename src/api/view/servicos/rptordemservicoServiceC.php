            ...
            <td width="935" height="1271"><table   width="942" border="0">
                <tr>
                  ...
                  <td width="539"><div align="left"  > <strong class="style53">
                    ...
                    Email:
                      <?=$EMAIL;?>
                     </span><span class="style53"><span  ><br />
                      </span></div></td>
                  <td width="281" align="right"><p class="style31 style39"><span class="style53">    <?=$telefone;?><br/>
                      <?=$telefonefax;?><br />
                       CNPJ:
                      <?=$cnpj;?>
                      </span></strong></p>
                        ...
                        <tr>
                          <td colspan="2" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
                           <tr>
                                ...
                                <td width="215" class="style38">Nota Fiscal:
                                  <span class="style37"><?=$rstPedido["Nota_Fiscal"];?></span></td>
                                <td width="176" class="style38">Emiss&atilde;o:                                <span class="style37"> <?=$rstPedido["datanf"];?><span></td>
                              </tr>
                              <tr>
...
?> <td width="11%"><div align="center">
	  ...
	  ?>
                ...
                <tr>
                  <td height="21" colspan="6" class="style37" align="right">&nbsp;</td>
                </tr>
                <tr>
