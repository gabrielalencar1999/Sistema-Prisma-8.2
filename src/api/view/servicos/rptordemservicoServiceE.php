      ...
      <?php } ?>
            ...
            <td width="854"><div align="left" class="style31 style39" > <span class="style53" style="margin-booton:10px"><strong>
              ...
              -
                ...
                <strong>Telefones: <?=$telefone;?></strong> <strong>Email: <?=$EMAIL;?></strong></span><span class="style53"><span  ><br />
                  </span></span></div></td>
            ...
            <td height="75" colspan="3"><div >
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td colspan="2" class="style53"><?=$rstPedido["Nome_Consumidor"];?></td>
                  <td class="style37"><span class="style38">Telefones:</span></td>
                  <td colspan="2" class="style53">
                  <?php
                ...
                <tr>
                  ...
                  <td colspan="2" class="style53"><?=$rstPedido["Nome_Rua"];?>   <?=$rstPedido["Num_Rua"];  if ($rstPedido["COMPLEMENTO"] != "" ) { echo " - ".$rstPedido["COMPLEMENTO"]; }?></td>
                  <td width="76" class="style37"><span class="style38">Bairro:</span></td>
                  <td width="150" class="style53"><span >                    
                    <?=$rstPedido["bairros"];?>
                    </span></td>
                  <td width="188" class="style37"><strong>
                    
                    CEP:</strong>
                    <span class="style53"><?=$rstPedido["ceps"];?></span>
                    </span></td>
                  </tr>
                <tr>
                  <td class="style38"><span class="style38">Cidade:</span></td>
                  <td width="178" class="style53"><?=$rstPedido["cidades"];?>  </td>
                  <td width="142" class="style37"><strong class="style38">UF:</strong>
                  <span class="style53"> <?=$rstPedido["estado"];?> </span>                 </td>
                  <td class="style37"><strong>CPF/CNPJ:</strong></span></td>
                  <td class="style53"> <?=$rstPedido["CGC_CPF"];?></td>
                  <td class="style38"><strong>Inscri&ccedil;&atilde;o Estadual:</strong>
                ...
                <tr>
                  ...
                  <td colspan="3" class="style37"><strong>Email:</strong>
                    <span class="style53"><?=$rstPedido["EMail"];?></span>
                   </td>
                  </tr>
                </table>
              </div></td>
...
?>
      ...
      <?php } ?>
         ...
         <td  colspan="15"><span class="style38">Observa&ccedil;&atilde;o</span> <span class="style37"><?=$rstPedido["OBSERVACAO_atendimento"];?></span></td>
            ...
            <td width="854"><div align="left" class="style31 style39" > <span class="style53" style="margin-booton:10px"><strong>
              <?=$fantasia;?>
                ...
                <?=$estado;?>
                 ...
                 <strong>Telefones: <?=$telefone;?></strong>
                <strong>Email:
                  <?=$EMAIL;?>
                  </strong></span><span class="style53"><span  ><br />
                  </span></span></div></td>
          ...
          <tr>
            <td  align="center"height="21" colspan="3">&nbsp;</td>
            </tr>
          <tr>
          ...
          <tr>
            <td height="12" colspan="3"><table width="100%" border="0">
              <tr>
  ...
  <?=$rstPedido['tecnico'];?>
          ...
          <tr>
            <td height="12" colspan="3"><table width="913" border="0">
              <tr>
                <td class="style37"> <img src="../logos/marcas9053A.jpg" alt=""/></td> <?php /*<strong>Compre produtos direto da F&aacute;brica pelo Site https://shopclub.com.br/<br />
