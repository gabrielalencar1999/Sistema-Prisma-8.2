...
if($datafim == ""  ) {
  ...
  if($oficina != "") { 
     ...
     $sql = "Select CODIGO_CHAMADA, S.DESCRICAO,Nome_Consumidor,preventivo,marca,g_sigla,
...
if ( $stm->rowCount() > 0 ){        
  ...
  <h3>Qtde: <?=$contador;?> Total: R$ <?=number_format($valorTotal_atendimento - $total_descontos,2,',','.');?></h3>
