...
$datahora      = $ano . "-" . $mes . "-" . $dia . " " . $hora;
  ...
  $_assuntoAtividade = "Impressão O.S Termo";
...
<table width="999" border="0" cellspacing="0" cellpadding="00">
  <tr >
    <td width="84" ><div align="left" class="style31" style="margin-left:5px"> <span class="style31" style="margin-left:5px">
      <?php if($logo64 != "") {?>
    ...
    <td width="896"><div align="center" class="style31 style39" ><span class="style53"><strong style="font-size:22px">
      <?=$fantasia;?>
      </strong> <br />
...
<table width="996" border="1" cellpadding="00" cellspacing="0" class="bordasimples" style="margin-bottom:10px">
  <tr>
    <td height="80" colspan="2" style="text-align:center"><span class="style48" >TERMO DE RESPONSABILIDADE</span></td>
  </tr>
  <tr>
    <td width="536"  style="padding:10px"><strong>NORMAS E PROCEDIMENTOS</strong><br /></td>
    <td width="454" style="text-align:center;padding:10px"><span ><span style="padding:10px"><strong>ORDEM SERVIÇO </strong></span><br />
      <span class="style48">
      <?=$rstPedido["CODIGO_CHAMADA"];?>
    </span></span></td>
  </tr>
  <tr>
   <td colspan="2"  style="padding:10px"><span style="text-align:justify">
          <?=$_htmlcustom;?>
        </span></td>
  </tr>
</table>
<table width="994" border="0" cellspacing="0" cellpadding="00">
  <tr>
    <td width="508" height="52"><span style="text-align:left" class="style39">
      <?=$cidade;?>, <?=$datadia;?>
    </span></td>
    <td width="486"><span style="text-align:center">______________________________________________________<strong><bR />
      <span class="style391" style="font-size:16px">
      <?=$rstPedido["Nome_Consumidor"];?>
    </span></strong></span></td>
  </tr>
  <tr>
    <td height="48" colspan="2" style="text-align:center"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
   </td>
  </tr>
  <tr>
    <td colspan="2" style="text-align:center"><table width="996" border="1" cellpadding="00" cellspacing="0" class="bordasimples" style="margin-bottom:10px">
      <tr>
        <td height="57" colspan="2" style="text-align:center"><span  ><strong>TERMO DE RESPONSABILIDADE</strong></span></td>
      </tr>
      <tr>
        <td width="536"  style="padding:10px"><strong>NORMAS E PROCEDIMENTOS</strong><br /></td>
        <td width="454" style="text-align:center;padding:10px"><span ><span style="padding:10px"><strong>ORDEM SERVIÇO </strong></span><br />
      ...
      <table width="994" border="0" cellspacing="0" cellpadding="00">
        <tr>
          ...
          <td width="486">______________________________________________________<strong><br />
            <span class="style391" style="font-size:16px">
            <?=$rstPedido["Nome_Consumidor"];?>
          </span></strong></td>
        </tr>
