	...
	<div class="wrapper">
		<form class="form-horizontal m-t-20" id="form1" name="form1" method="post" action="">
	        ...
	        <div class="row button-list"  >
                    ...
                    <a href="javascript:void(0)" onclick="_geral('_Fl00004', '146')">
                        <div class="widget-bg-color-icon card-box <?php if($_SESSION['per146'] == ""){ echo 'disabled'; } ?>">
                        <div class="bg-icon pull-left">                          
                           <i class="icon-calculator fa-2x"></i>                  
                        </div>
                            <div class="text-left">
                                <h4 class="text-dark"><b>Financeiro </b></h4>
                                <p class="text-muted">Controle e Lançamentos</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                    <a href="javascript:void(0)"   onclick="_geral('_Fl00012','105')">
                        <div class="widget-bg-color-icon card-box <?php if($_SESSION['per105'] == ""){ echo 'disabled'; } ?>">
                        <div class="bg-icon pull-left">                          
                           <i class=" ti-receipt fa-2x"></i>                  
                        </div>
                            <div class="text-left">
                                <h4 class="text-dark"><b>Resumo Caixa </b></h4>
                                <p class="text-muted">PDV-Vendas/O.S</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </a>
                    ...
                    <div class="col-md-6 col-lg-3"> 
                        <a href="javascript:void(0)" onclick="_geral('_Fl00020','109')">
							<div class="widget-bg-color-icon card-box fadeInDown animated <?php if($_SESSION['per109'] == ""){ echo 'disabled'; } ?>">
								<div class="bg-icon pull-left">                          
								...
								<div class="clearfix"></div>
                                    ...
                                    <!--
                   <div class="col-md-6 col-lg-3">
                    <a href="javascript:void(0)" id="_00004">
                        <div class="widget-bg-color-icon card-box">
                        <div class="bg-icon pull-left">                          
                          <i class="ti-shopping-cart-full fa-2x"></i>                   
                        </div>
                            <div class="text-left">
                                <h4 class="text-dark"><b>Compras </b></h4>
                                <p class="text-muted">Pedidos, consultas e cotação</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </a>
