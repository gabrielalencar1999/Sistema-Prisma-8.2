				...
				<div class="card-box" id="bbody" style=" background:rgba(255, 255, 255, 0.9)">
					...
					<div class="row button-list" style="display:none;" id="page3">	
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            <div style="height:142.5px;">
                                <a href="javascript:void(0)" onclick="_geral('tpgar00001','159')">
                                    <div class="widget-bg-color-icon card-box fadeInDown animated <?php if($_SESSION['per159'] == ""){ echo 'disabled'; } ?>">
                                        <div class="bg-icon pull-left">
                                            <i class=" typcn typcn-cog-outline fa-2x"></i>
                                        </div>
                                        <div class="text-left">
                        ...
                        */?>
                        ...
                        <div class="col-md-4">
                            <div style="height:142.5px;">
                                <a href="javascript:void(0)" onclick="_geral('bk_00001','162')">
                                    <div class="widget-bg-color-icon card-box fadeInDown animated <?php if($_SESSION['per162'] == ""){ echo 'disabled'; } ?>">
                                        <div class="bg-icon pull-left">
                                            <i class="fa  fa-cloud-download fa-2x"></i>
                                        </div>
                                        <div class="text-left">
                                            <h4 class="text-dark"><b>Backup</b></h4>
                                            <p class="text-muted">Lista de Backup Gerados</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </a>
