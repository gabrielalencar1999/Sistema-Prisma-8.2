        ...
        */
        ...
        while($rtos = mysqli_fetch_array($ex))						
        {
            ...
            */
            ...
            $periodo = $rtos["trackO_periodotemp"];  
            $ordem =  $rtos["trackO_ordemtemp"]; 
        ...
        ?>
                            <li class="task-<?=$_corAtendimento;?>" id="_id<?=$rtos['trackO_chamada'];?>" name="_id<?=$rtos['trackO_chamada'];?>">
                                    ...
                                    <?php if($trackO_salvar == 1){ ?>
                                        <span class="badge badge-<?=$_corAtendimento;?> m-l-0"><?=$_PERIDOESCOLHIDO;?></span>
                                    <?php  
                                    }else { ?>                                   
                                        <p class="pull-right m-b-0">  <button type="button" class="btn btn-warning waves-effect waves-light" onclick="_ordemOS('<?=$rtos['trackO_chamada'];?>','warning','2','<?=$rtos['trackO_tecnico'];?>')">Manhã</button>
                                        ...
                                        <p class="m-b-0"> <span class="font-bold"><strong>OS <?=$rtos['trackO_chamada'];?><br> </strong></span> </p>
                                    <?php } ?>
                                    </div>
                            </li>   
        <?php 
