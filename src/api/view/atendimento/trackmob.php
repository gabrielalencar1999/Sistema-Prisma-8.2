...
<body>
    ...
    <div class="wrapper" style=" z-index: 2;background: url(assets/images/agsquare.png);" id="_principal" style="display:''">
        <div style="margin:5px 20px 20px 20px;">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <h4 class="page-title m-t-15">PrismaMob</h4>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive" id="resultado" style="padding:0px">
                            ...
                            $_LINK = "_ATa000122";
                            // require_once('../../api/view/atendimento/trackmoblist.php');
                            require_once('../../api/view/atendimento/trackmoblistGerencial.php'); ?>
                        </div>
                    </div>
                </div>
            <?php } ?>
...
-->
    ...
    function _idexcluirpgtoID() {
        ...
        function _motivofinalizar(_idmot) {
          ...
          function _atualizarSitPrismaMob(_idOS) {
           
            $('#_datarefid').val(_idOS);
            $('#_sittrackmob').val( $('#sitprismamob').val());
