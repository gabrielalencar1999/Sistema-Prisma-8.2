        ...
        //0 busca da OS        
            ...
            while($row = mysqli_fetch_array($resultado)){
                   ...
                   // $_sitelx  =  $row["CODIGO_CHAMADA"] ;
                    ...
                    $fone = mascara($row["DDD"].$row["FONE_RESIDENCIAL"], 'telefone') . " " . mascara($row["DDD"].$row["FONE_COMERCIAL"], 'telefone') . " " . mascara($row["DDD"].$row["FONE_CELULAR"], 'telefone');
                                               ...
                                               <div class="widget-profile-one">
                                                            ...
                                                            <?php if($_sitelx != 1) {
                                                               ?>
                                                                ...
                                                                <div class="row" >
                                                                <?php
                                                                 //busca situações oficina
                                                                 $sql = "Select * from " . $_SESSION['BASE'] . ".situacao_oficina where sitmobOF_vispainel	 = 1 OR sitmobOF_vispainel	 = 2"; 
                                                                 $stm = $pdo->prepare("$sql");                     
                                                                 $stm->execute();                                                             
                                                                 if ($stm->rowCount() > 0) {                                                             
                                                                 ...
                                                                 ?>                                                        
                                                                    <div class="col-sm-6 col-xs-12" >                                                                   
                                                                         <a href="#finalizar-2" data-toggle="tab" aria-expanded="true" onclick="_ativa('')">     
                                                                          <button id="cadastrar" type="button" class="btn btn-block btn-lg  waves-effect waves-light mb-auto"   style="margin:5px;background-color:<?=$linha->sitmobOF_cortable;?>;color:<?=$linha->sitmobOF_cortfont;?>;" onclick="_motivo('<?=$linha->sitmobOF_id;?>','<?=$linha->sitmobOF_vispainel;?>')"><i class="<?=$linha->sitmobOF_img;?> "></i> <?=$linha->sitmobOF_descricao;?></button>      
                                                                         </a>
                                                                    </div>
                                                                    <?php  } 
                                                                    }?>
